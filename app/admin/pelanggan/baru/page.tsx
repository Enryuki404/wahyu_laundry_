    ...
    <div className="space-y-6 animate-[wlIn_0.45s_ease]">
      <div className="bg-white rounded-[16px] shadow-[0_8px_28px_rgba(15,23,42,.06)] border border-slate-100 p-6">
        <div className="flex items-center gap-3 mb-3">
          ...
          <h1 className="text-xl font-black text-[#1E293B] tracking-tight">Pendaftaran Pelanggan</h1>
        ...
        <p className="text-sm text-slate-500 font-medium">Form tambah pelanggan baru — placeholder.</p>
        ...
        <div className="mt-4 p-4 bg-[#F8FAFC] border border-dashed border-slate-200 rounded-xl text-center">
          ...
          <div className="text-xs text-slate-400">Placeholder aman — tidak memicu 403 untuk role admin</div>
        </div>
      </div>
    </div>
  );
