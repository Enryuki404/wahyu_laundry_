    ...
    <div className="space-y-6 animate-[wlIn_0.45s_ease]">
      <div className="bg-white rounded-[16px] shadow-[0_8px_28px_rgba(15,23,42,.06)] border border-slate-100 p-6">
        <div className="flex items-center gap-3 mb-3">
          ...
          <h1 className="text-xl font-black text-[#1E293B] tracking-tight">Manajemen Gaji</h1>
        ...
        <p className="text-sm text-slate-500 font-medium">Perhitungan gaji, lembur, approval — placeholder.</p>
